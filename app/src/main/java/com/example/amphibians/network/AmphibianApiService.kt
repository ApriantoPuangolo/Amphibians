...
private val retrofit = Retrofit.Builder()
    ...
    .baseUrl(BASE_URL)
    .build()
//menentukan cara Retrofit berbicara ke server web menggunakan permintaan HTTP.
...
//menambahkan lapisan jaringan ke project Amphibians yang digunakan ViewModel untuk berkomunikasi dengan layanan web.
